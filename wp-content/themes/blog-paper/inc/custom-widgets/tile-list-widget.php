<?php
if ( ! class_exists( 'Blog_Paper_Tile_List_Widget' ) ) {
	/**
	 * Adds Blog Paper Tile List Widget.
	 */
	class Blog_Paper_Tile_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$tile_list_widget = array(
				'classname'   => 'widget blog-paper-widget tile-list-widget',
				'description' => __( 'Retrive Tile List Widgets', 'blog-paper' ),
			);
			parent::__construct(
				'blog_paper_tile_list_widget',
				__( 'Artify Widget: Tile List Widget', 'blog-paper' ),
				$tile_list_widget
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'blog-paper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'blog-paper' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" style="width:100%;">
					<?php
					$categories = blog_paper_get_post_cat_choices();
