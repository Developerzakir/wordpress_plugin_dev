...
<main id="primary" class="site-main">
	...
	while ( have_posts() ) :
		...
		if ( is_singular( 'post' ) ) {
			...
			if ( $query->have_posts() ) :
				$related_title = get_theme_mod( 'blog_paper_related_posts_title', __( 'Related Posts', 'blog-paper' ) );
				?>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								<div class="single-card-container grid-card">
									<div class="single-card-image">
										<a href="<?php the_permalink(); ?>"><?php blog_paper_post_thumbnail(); ?></a>
									</div>
									<div class="single-card-detail">
										...
										<div class="post-exerpt">
											<p><?php echo wp_kses_post( wp_trim_words( get_the_excerpt(), get_theme_mod( 'blog_paper_excerpt_length', 30 ) ) ); ?></p>
										</div><!-- post-exerpt -->
										<div class="card-meta">
