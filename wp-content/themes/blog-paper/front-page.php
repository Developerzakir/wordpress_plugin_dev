...
if ( blog_paper_is_latest_posts() ) {

	require get_home_template();

} elseif ( blog_paper_is_frontpage() ) {
...
if ( get_theme_mod( 'blog_paper_enable_frontpage_content', false ) === true && 'page' == get_option('show_on_front') ) {
	?>
